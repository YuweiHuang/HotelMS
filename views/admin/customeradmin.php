...
<br/>
  <div class="container" style="padding: 0px 300px 0px 300px">
    <div class="page-header" >
      <h1 align="center" style="font-family:	Microsoft YaHei">删除住客信息</h1>
    </div>
  <form class="form-signin" role="form" action="" method="POST">
  <div>
    ...
    <div class = "form-group">
     <label for = "floor">身份证号</label>
     <input type="text" class="form-control" name="deleteby_cid" placeholder="身份证号" required >
     <span class="error"></span><br/>
    </div>

    </div>
      <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit_deletec">删除</button>
      </form>
    </div>
