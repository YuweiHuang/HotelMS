        ...
        $.post('../php/roomlist.php',{
            ...
            for( var i = 0; i < data.length; i++ ) {
                ...
                var days_id="days_"+data[i].room_id;
                 ...
                 html +=     "<td>";
                 html +=     "<button class='btn btn-small btn-primary' data-toggle='modal' data-target='" +target_reset+ "'>修改</button>";
                 ...
                 html +=                            "<div class='form-group'>"; //textarea显示评论，用户可查看自己之前的评论或者更新评
                ...
                html +=                                "<label for='name'>days</label>";
                 ...
                 html +=                            "<button type='button' class='btn btn-default update' data-dismiss='modal' id='"+data[i].room_id+"'>提交</button>";
                 html +=                        "</div>";
                 html +=                    "</form>";
                 html +=                "</div>";
                 html +=            "</div>"
            ...
            $(".confirmDelete").click(function() 
            {
                ...
                $.post('../php/test.php',
                    ...
                    function()
                    {
                        ...
                        window.location.href="roomadmindel.php";
                    }
                );
            });
        },'json'
