$(function(){
	...
	$.ajax({
		type: 'post',
		url: '../../controlers/adminAction/userList.php',
		cache: false,
		dateType:'json',
		success: function(data) {
            ...
            for( var i = 0; i < data.length; i++ ) 
            {
                ...
                var member_type_id_id="member_type_id_"+data[i].user_id;
                 ...
                 html +=                                " <input type='text' class='form-control' id='"+register_time_id+"' size='5' value='"+data[i].register_time+"' disabled='disabled'>";
                 html +=                                "<label for='name'>账号</label>";
                 html +=                                " <input type='text' class='form-control' id='"+account_id+"' size='5' value='"+data[i].user_account+"' disabled='disabled'>";
...
$(document).on('click', 'button.update', function(){
    var getId = $(this).attr("id"); 
                ...
                $.ajax({
                    type: 'post',
                    url: '../../controlers/adminAction/userUpdate.php',
                    cache: false,
                    data: {
                        getId:getId,
                    ...
                    dateType:'json',
                    success: function(data){
window.location.href="../../views/admin/useradmindel.php";
                    },
                    error:function(){
            ...
            $(document).on('click', 'button.confirmDelete', function(){
             ...
             var getId = $(this).attr("id"); 
                ...
                $.post('../../controlers/adminAction/deleteUserOrAdminAction.php',
                    {
                        getId:getId
                    },
                    function()
